package cn.andyoung.jwt.config;

import cn.andyoung.jwt.filter.JwtAuthenticationFilter;
import cn.andyoung.jwt.filter.JwtAuthorizationFilter;
import cn.andyoung.jwt.service.UserDetailsServiceImpl;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    http.cors()
        ...
        .addFilter(
            new JwtAuthorizationFilter(
                authenticationManager(), cachingUserDetailsService(userDetailsServiceImpl)))
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    ...
    CachingUserDetailsService cachingUserDetailsService =
        cachingUserDetailsService(userDetailsServiceImpl);
