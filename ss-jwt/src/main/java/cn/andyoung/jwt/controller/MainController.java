package cn.andyoung.jwt.controller;

import cn.andyoung.jwt.annotation.IsAdmin;
import cn.andyoung.jwt.entity.ResponseEntity;
  ...
  public ResponseEntity everyone() {
    ...
    if (!(authentication instanceof AnonymousAuthenticationToken)) {
      ...
      return new ResponseEntity(
          HttpStatus.OK.value(), "You are already login", authentication.getPrincipal());
    } else {
